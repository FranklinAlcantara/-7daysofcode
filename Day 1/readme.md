Primeiro dia do desafio #7DaysOfCode

O enunciado não solicita a criação da página HTML, mas eu decidi fazer pelo exercício.

Segue abaixo o texto do email enviado com o enunciado.


Chegou a hora, Franklin! Você vai começar a sua jornada no #7DaysOfCode ;)
